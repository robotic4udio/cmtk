...
// Constructor to create a new Interval object from a string
Interval::Interval(std::string interval)
{
    set(interval);
}

// Constructor to create a new Interval object from a degree and a quality
Interval::Interval(int degree, int quality)
{
    set(degree, quality);
}

// Static function to create a new Interval object
Interval Interval::NewFromSemi(int semitones, bool sharp)
{
    Interval res;
...
Interval& Interval::set(std::string aName)
{
...
Interval& Interval::set(int aDegree, int aQuality)
{
...
Interval& Interval::setFromSemi(int s, bool sharp)
{
    int octave = 0;
    while(s >= 12)
    {
...
// Function to get the interval as a string
const std::string Interval::getName() const
{
    return std::move(toString());
}

// Function to get the number of semitones
const int Interval::getSemi() const
{
    return mSemitones;
}

// Print the interval
Interval& Interval::print()
{
...
// Set quality
Interval& Interval::setQuality(int aQuality)
{
...
Interval& Interval::setQuality(std::string aQuality)
{
    int newQuality = 0;
    for(auto c : aQuality)
    {
...
Interval& Interval::setQuality(char aQuality)
{
...
// Get Quality
const int Interval::getQuality() const
{
    return mQuality;
}

// Get Degree
const int Interval::getDegree() const
{
    return mDegree;
}

// Set Degree
Interval& Interval::setDegree(int aDegree, bool keepSemi)
{
...
// Set Degree
Interval& Interval::setDegreeKeepSemi(int aDegree)
{
    mDegree = aDegree;
...
Interval& Interval::setDegreeSemi(int aDegree, int aSemi)
{
    mDegree = aDegree;
    mSemitones = aSemi;
...
const bool Interval::operator==(const std::string& intervalString) const
{
...
Interval Interval::operator+(int n) const
{
...
// operator+= for Semitones
Interval& Interval::operator+=(int n)
{
...
Interval& Interval::shiftOctave(int n)
{   
...
std::string Interval::getNoteName(int rootNote, bool isRoman) const
{
    // Get the note number
...
Interval Interval::getNegativeHarmonic() const
{
...
// Transpose
Interval& Interval::transpose(int n)
{
...
// Static: Create a new Interval from a Roman Numeral
Interval Interval::NewFromRoman(std::string roman)
{
    Interval res;
    res.setRoman(roman);
    return std::move(res);
...
Interval& Interval::setRoman(std::string aRoman)
{
    clear();
...
std::string Interval::getRoman(bool upperCase) const
{
    std::string res = "";
...
std::string Interval::getDegreeRoman(bool upperCase) const
{
...
void Interval::updateSemitones(int aDegree, int aQuality)
{
    mSemitones = aQuality + getSemiFromMajorDegree(aDegree);
}

int Interval::getSemiFromMajorDegree(int aDegree)
{
    auto semitones = 0;
    while(aDegree > 7)
    {
...
// ------------------------------------------------------------------------------------------------ //
// Constructor
Intervals::Intervals(IntervalVector intervals)
{
    set(intervals);
}

// Constructor
Intervals::Intervals(std::string intervals)
{
    set(intervals);
}

// Function to set the intervals
Intervals& Intervals::set(const IntervalVector& intervals)
{
    // Clear the intervals
...
Intervals& Intervals::set(const std::string& intervals)
{
    // Clear the intervals
    IntervalVector::clear();
...
Intervals& Intervals::operator=(const IntervalVector& intervals)
{
    set(intervals);
    return *this;
}
...
// Overload the assignment operator
Intervals& Intervals::operator=(const std::string& intervals)
{
    set(intervals);
    return *this;
}
...
Intervals& Intervals::add(const Interval& interval){
...
Intervals& Intervals::add(const Intervals& interval)
{
    for(auto& i : interval) add(i);
    return *this;
}

Intervals& Intervals::add(const IntervalVector& interval)
{
    for(auto& i : interval) add(i);
    return *this;
}

Intervals& Intervals::add(int degree, int quality)
{
    add(Interval(degree, quality));
    return *this;
}

Intervals& Intervals::add(std::string str)
{
...
// Add semitone
Intervals& Intervals::addSemi(int semi, bool sharp)
{
...
// Add semitones
Intervals& Intervals::addSemi(std::vector<int> semi, bool sharp)
{
...
// Remove semitone
Intervals& Intervals::removeSemi(int semi)
{
...
// Remove semitones
Intervals& Intervals::removeSemi(std::vector<int> semi)
{
...
Intervals& Intervals::insert(int index, const Interval& n){
...
bool Intervals::remove(const Interval& n)
{
...
Intervals& Intervals::rotate(int n)
{
    // Rotate the intervals
...
bool Intervals::remove(const std::string& str)
{
    bool changed = false;
...
void Intervals::remove(int degree, int quality)
{
...
void Intervals::removeDegree(int aDegree)
{
...
Intervals Intervals::FromString(std::string str)
{
...
Intervals& Intervals::setQuality(int aDegree, int aQuality, bool allowAdd)
{
...
bool Intervals::contains(const Interval& n) const
{
...
// Test if an interval is present
const bool Intervals::contains(const std::string& yes) const
{
...
const bool Intervals::containsNot(const std::string& no) const
{
...
const bool Intervals::contains(const std::string& yes, const std::string& no) const
{
    return contains(yes) && containsNot(no);
}

// Contains Degree
const bool Intervals::containsDegree(int degree) const
{
...
const std::vector<int> Intervals::getSemi(int offset) const
{
    std::vector<int> res;
    for(auto& interval : *this)
    {
...
std::vector<int> Intervals::getSemiNormalized()
{
    auto semi = getSemi();
...
const Interval& Intervals::getMedian() const
{
    auto intervals = *this;
...
int Intervals::getMedianSemi() const
{
    auto semi = getSemi();
...
Intervals Intervals::NewFromSemi(std::vector<int> semitones, bool normalize)
{
    Intervals res;
...
// Set from a vector of semitones - The lowest semitone will be treated as the root
void Intervals::setFromSemi(std::vector<int> semitones, bool normalize)
{
    // Sort the semitones
